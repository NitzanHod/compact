""" Finetuning a huggingface transformers model for sequence classification on GLUE."""
import argparse
import json
import logging
import math
...
from random_utils import Manager
from torchrun_main import replace_parameters
...
def parse_args():
    ...
    parser.add_argument("--train_file", type=str, default=None, help="A csv or json file of the training data.")
    parser.add_argument("--validation_file", type=str, default=None, help="A csv or json file of the validation data.")
    parser.add_argument("--max_length", type=int, default=128, help=(
        ...
        "be truncated, sequences shorter will be padded if `--pad_to_max_length` is passed."))
    ...
    parser.add_argument("--lr", type=float, default=5e-5, help="Initial learning rate (after the potential warmup period) to use.", )
    parser.add_argument("--weight_decay", type=float, default=0.0, help="Weight decay to use.")
    parser.add_argument("--num_train_epochs", type=int, default=3, help="Total number of training epochs to perform.")
    parser.add_argument("--max_train_steps", type=int, default=None, help="Total number of training steps to perform. If provided, overrides num_train_epochs.", )
    parser.add_argument("--gradient_accumulation_steps", type=int, default=1, help="Number of updates steps to accumulate before performing a backward/update pass.", )
    parser.add_argument("--lr_scheduler_type", type=str, default="linear",
                        choices=["linear", "cosine", "cosine_restarts", "exponential"])
    ...
    parser.add_argument("--single_gpu", default=True, action="store_true") #ALWAYS true for finetune, unused.
...
def main(args):
    wandb.init(entity="gnn-depth", project="memory-eff-llms", group=args.group, name=args.name, config=vars(args))
    ...
    if 'bert' in args.model_name_or_path:
        ...
        print('Enabling LoRA for all modules', target_modules_list)
    ...
    if not args.memory_efficient:
        ...
        small_params, param_groups = replace_parameters(model, args, is_roberta='roberta' in args.model_name_or_path)
        print(model)
